...
public class FindQuestionsGUI extends JFrame {
	...
	private JButton jButtonClose = new JButton(ResourceBundle.getBundle("Etiquetas").getString("WalletBack"));
	...
	{	
		...
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("FindQuestion"));

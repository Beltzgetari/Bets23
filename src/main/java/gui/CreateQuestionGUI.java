...
public class CreateQuestionGUI extends JFrame {
	...
	private void jbInit(ArrayList<domain.Event> v) throws Exception {
		...
		jButtonCreate.setForeground(new Color(255, 255, 255));
		jButtonCreate.setBackground(new Color(0, 0, 0));

		jButtonCreate.setBounds(new Rectangle(110, 275, 130, 30));
		...
		JButton jButtonBack = new JButton(ResourceBundle.getBundle("Etiquetas").getString("LoginGUI_back"));
		jButtonBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminGUI admin = new AdminGUI();
				admin.setVisible(true);
				CreateQuestionGUI.this.setVisible(false);
			}
		});
		jButtonBack.setBounds(new Rectangle(275, 275, 130, 30));
		jButtonBack.setBackground(Color.WHITE);
		jButtonBack.setBounds(327, 275, 130, 30);

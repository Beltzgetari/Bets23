...
public class removeFollowDAWTest {
	...
	public void initialize() {
		...
		Pira= new User("Pira", "OnePieceUnaMierda", "Mikel", 19 );
		Xabi = new User("MundukoErregie", "OnePieceUnaMierda", "Xabi", 20);
		Xabi.addJarraitu(Mikel);
		Mikel.addJarraitzaile(Xabi);
		Pira.addJarraitu(Xabi);
		Pira.addJarraitu(Mikel);
		Xabi.addJarraitzaile(Pira);
		Mikel.addJarraitzaile(Pira);
		da = new DataAccess();
		da.ezabatu();
	...
	public void Test7() {
		...
		System.out.println(sizelista1);
		System.out.println(sizelista2);
		...
		System.out.println(sizeberria1);
		System.out.println(sizeberria2);
